    ...
    return (
        <nav style={styles.nav}>
            ...
            <div style={styles.links}>
                ...
                <Link to="/browse" style={styles.link} className="nav-link">Browse Books</Link>
                
                {user && user.isAdmin && (
                    <>
                        <Link to="/books" style={styles.link} className="nav-link">Manage Books</Link>
                        <Link to="/box" style={styles.link} className="nav-link">Manage Boxes</Link>
                    </>
                )}
